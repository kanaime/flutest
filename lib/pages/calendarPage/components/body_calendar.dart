import 'package:flutest/pages/calendarPage/components/calendar_dates.dart';
import 'package:flutest/pages/calendarPage/components/dates_list.dart';
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return CalendarDates(
                      day: days[index],
                      date: dates[index],
                      dayColor: index == 0 ? Colors.pink : Colors.black54,
                      dateColor: index == 0 ? Colors.purple : Colors.yellow,
                    );
                  },
                ),
              ),
